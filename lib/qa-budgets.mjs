...
// point. Measured on the ten-lot city (boulevard 205 calls / 84,508 tris;
// shopfront 65 / 6,970) and given headroom; the per-plot caps in
// lib/validate-plot.mjs (50k triangles, 4 materials, 3 lights) are what keep
// the slope honest.
//
